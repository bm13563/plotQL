...
enum {
  ...
  anon_sym_GT = 24,
  sym_query = 25,
  sym_series_clause = 26,
  sym_with_clause = 27,
  sym_plot_clause = 28,
  sym_filter_clause = 29,
  sym_condition = 30,
  sym_format_clause = 31,
  sym_format_option = 32,
  sym_column_ref = 33,
  sym_aggregate_call = 34,
  sym_string = 35,
  sym_operator = 36,
  aux_sym_query_repeat1 = 37,
  aux_sym_filter_clause_repeat1 = 38,
  aux_sym_format_clause_repeat1 = 39,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filter_clause, 3),
  [11] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_column_ref, 1),
  [15] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_filter_clause_repeat1, 2),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_filter_clause_repeat1, 2), SHIFT_REPEAT(33),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_aggregate_call, 4),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_series_clause, 1),
  ...
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filter_clause, 2),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_query_repeat1, 2),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_query_repeat1, 2), SHIFT_REPEAT(22),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query, 2),
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_format_clause, 3),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_plot_clause, 6),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_format_clause_repeat1, 2),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_format_clause_repeat1, 2), SHIFT_REPEAT(31),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_series_clause, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operator, 1),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_format_clause, 2),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_format_option, 3),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_series_clause, 3),
  ...
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_with_clause, 2),
